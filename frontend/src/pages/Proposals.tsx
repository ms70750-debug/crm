        ...
        <Panel>
          <div className="overflow-x-auto">
            <table className="w-full min-w-[820px]">
              <thead className="text-slate-400"><tr><th className="table-cell">Cliente</th><th className="table-cell">Produto</th><th className="table-cell">Banco</th><th className="table-cell">Valor</th><th className="table-cell">Parcela</th><th className="table-cell">Status</th><th className="table-cell">Acoes</th></tr></thead>
